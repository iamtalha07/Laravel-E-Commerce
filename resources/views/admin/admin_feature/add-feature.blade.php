        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" id="feature_title" placeholder="Enter Feature Title">
                    @error('title')
              ...
              <!-- /.col -->
              <div class="form-group">
                <label for="icon">Feature Icon</label>
                <input type="text" class="form-control" name="icon" id="icon" style="width: 510px;" placeholder="Html for Icon" >
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="content" rows="3" placeholder="Enter Description"></textarea>
          </div>
