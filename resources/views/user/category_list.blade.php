            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            @if($isExist==null)
                            <h2>There is no product for this category</h2>
                            @else 
                    ...
                    <div class="col-lg-4 sidebar">
                        <div class="sidebar-widget category">
                            ...
                            <nav class="navbar bg-light">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{URL('category-list/'.$category->id )}}"><i class="fa fa-tshirt"></i>{{$category->title}}</a>
                                    </li>
                                    @endforeach
                        ...
                        <div class="sidebar-widget brands">
                            ...
                            <ul>
                                ...
                                <li><a href="{{URL('brand-list/'.$item->id )}}">{{$item->name}} ({{$item->products->count()}}) </a></li>
                                @endforeach
                            </ul>
                        </div>
