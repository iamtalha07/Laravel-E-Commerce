      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-header">Catalogues</li>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('add_categories')}}" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('add_dashboard_images')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Images</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('add_feature')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Features</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('store-details')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Store Details</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('view-details')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Details</p>
                </a>
              </li>
